...
export function LeadForm({ settings }: { settings: SiteSettings }) {
      ...
      <form onSubmit={handleStep1} className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1">
            ...
            <select id="situation" name="situation" className={fieldClass} defaultValue="">
              <option value="" disabled>
                Choose one
              </option>
        ...
        <div className="space-y-1">
          ...
          <textarea id="condition_notes" name="condition_notes" rows={3} className={fieldClass} />
        </div>
        ...
        <p className="text-xs leading-relaxed text-slatey">
          No obligation. We don&apos;t share your information. Sending this is not
          a contract, and any offer is non-binding until you sign a written
          agreement.
        </p>
      </form>
    );
  ...
  // Step 2 — property + situation details. All optional.
  return (
    <form onSubmit={handleStep2} className="space-y-5">
      <div className="rounded-md bg-accent/5 p-4">
        ...
        <p className="mt-1 text-sm leading-relaxed text-slatey">
          A few more details help us give you an accurate cash offer and listed
          estimate. Don&apos;t have an answer handy? Leave it blank.
        </p>
      </div>
      ...
      <p className="text-xs text-slatey">
        If we buy as-is, pay your closing and escrow costs, and close on the day
        you choose — what would feel fair to you?
      </p>
